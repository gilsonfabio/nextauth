    ...
    <div className='w-full h-screen flex items-center justify-center'>
      <form className='p-10 border rounded-lg w-96' onSubmit={handleLogin}>
        ...
        <div className='mt-5 flex flex-row items-center justify-between '>
          <Link href={'/auth/register'} className='text-sm text-blue-600 hover:text-blue-400 font-semibold'>Faça seu registro</Link>
          <Link href={'/auth/forgotpassword'} className='text-sm text-blue-600 hover:text-blue-400 font-semibold'>Esqueceu sua senha?</Link>
        </div>  
      </form>
